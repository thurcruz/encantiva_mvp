...
<head>
    ...
    <style>
        ...
        .adicional-row { display: flex; justify-content: space-between; align-items: center; border-bottom: 1px dotted #ddd; padding: 5px 0; }
        .adicional-row span { max-width: 75%; }
        .adicional-row input { max-width: 60px; text-align: center; padding: 5px; }
    </style>
</head>
<body>
